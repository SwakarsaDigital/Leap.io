...
export default function QuestBoard({ initialQuests, userRole }: QuestBoardProps) {
...
function QuestCard({ quest, userRole }: { quest: Quest; userRole: string }) {
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 hover:border-slate-700 transition-all group flex flex-col h-full relative overflow-hidden">
      ...
      <div className="mb-4 flex-1">
        ...
        {/* PERBAIKAN: Gunakan line-clamp-3 agar deskripsi tidak membuat kartu panjang sebelah */}
